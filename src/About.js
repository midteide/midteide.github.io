...
return (
        ...
        <div className="">
            ...
            <div className="single-post-content-wrapper p-3">
                ...
                only boosted further by the arrival of internet when I was 10. </p>
                <p>
                ...
                <figure className="figure image-wrapper float-right m-3 pl-3">
                    ...
                    />
                {/* <Image className="img-thumbnail figure-img img-fluid" roundedCircle src={require("./assets/telefon.jpg")}/> */}
                    {/* <img src={require("./assets/telefon.jpg")} className="figure-img img-fluid rounded" alt="" /> */}
                ...
                and always excelled in the programming subjects and I loved (still do) programming microcontroller circuits and then program
                ...
                Now however, I am very excited about being able to work as a SW developer full time.
            ...
            <h3 className="mt-5" style={{'text-align': 'center'}}>CV:</h3>
                ...
                {/* <div className="row">
                    <div className="image-wrapper float-left pr-3">
                        <Image className="img-thumbnail" roundedCircle src={require("./assets/meg2.png")}/>
                    </div>
                    <div className="col-6 col-md-6">
                        <p>Since I was a kid I have been interested in computers and electronics. 
                            We got a 386 computer when I was 7 and since then I developed a strong fascinations for computers, only boosted further with the arrival of internet when I was 10. I started scripting and learned myself some C/C++.</p>
                    </div> */}
