...
export const CabinControl = () =>   {
    ...
    >
     ...
     //volatile long int tempN=0, tempNminus1=0, tempNminus2=0, tempNminus3=0,kukk=4;
     ...
     */	
         ...
         if (c > 99) {
           ...
           //sprintf(charBuffer,"$D%04d__%06d#",tempN,kukk);
     ...
     void getTemp(char init)
     {
       ...
       if (init == true){
         ...
         tempUteN = avgTemp;
             ...
             //sprintf(charBuffer,"$D%04ld__%06ld__%06ld__%06ld__%06ld__%06ld#",avgTemp,tempN,tempNminus1,tempNminus2,tempNminus3,kukk);
           //sprintf(charBuffer,"$D%01d%04d%+04d%+04d%03d%02d%01d%01d#",0,1,2,3,4,5,6,7);
           //for (int i=0;i<23;i++)	TxByte(charBuffer[i]);
           //prints(charBuffer);
